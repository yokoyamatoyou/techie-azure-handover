...
ROUTE_ID = "gpt54_full_reasoning_none_shadow_v1"
MODEL_NAME = "gpt-5.4"
...
DEFAULT_OUTPUT_ROOT = (
    ...
    / "routes"
    / "gpt54_full_reasoning_none_live_20260506"
)
...
def run_preflight(root: Path) -> dict[str, Any]:
    ...
    base._write_text(
        ...
        "\n".join(
            [
                "# gpt54_full_reasoning_none_shadow_v1 preflight",
                "",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Opt-in gpt-5.4 reasoning_effort=none shadow route.")
